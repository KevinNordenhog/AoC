...
cardsInStrengthOrder = ['A', 'K', 'Q', 'J', 'T', '9', '8', '7', '6', '5', '4', '3', '2']
...
QQQJA 483"""
    ...
    assert partOneResult == 6440, "got result: {}".format(partOneResult)

    partTwoResult = partTwo(testlines)
    assert partTwoResult == 0000, "got result: {}".format(partTwoResult)
