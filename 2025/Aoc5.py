...
"""
    ...
    assert partOneResult == 3, "got result: {}".format(partOneResult)

    partTwoResult = partTwo(testlines)
    assert partTwoResult == 14, "got result: {}".format(partTwoResult)
